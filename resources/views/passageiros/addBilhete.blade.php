...
<div class="h-100 w-100 align-items-center d-flex flex-column">
    ...
    <div class="col-7 d-flex row h-100 justify-content-center align-items-center"> 
        <div class="col-5 mt-3 justify-content-center  d-flex flex-row align-items-center ">
            <label for="tipoBilhete" class="text-center">Tipo</label>
            <select id="tipoBilhete" class="form-control ms-2" name="tipoBilhete">
        ...
        <div class="col-7 mt-4 d-flex align-items-center">
            <label for="status" style="width: 40%" class="py-2 text-center">Status</label>
            <select id="status" class="form-control" name="status" style="width:60%">
        ...
        <div class="d-flex justify-content-end align-items-end">
            <div class="col-12"><div class="d-flex justify-content-end mt-xl-5 mb-xl-3">
                <button  id="bt-cancelarBilhete" class="btn btnCss fw-bold py-1" style="">Cancelar</button>
                <button  type="submit" class="btn btnCss fw-bold ms-5 py-1"  style="width: 5vw">Enviar</button>
            </div></div>
        </div>
    </div>
    </form>
