...
<div class="h-100 w-100">
    ...
    <div class="col-7 d-flex row  justify-content-center align-items-center"> 
        <div class="col-5 d-flex align-items-center"><input class="form-control" type="text" name="nomePassageiro" id="name"
                ...
                <div class="col-5 d-flex align-items-center"><input data-mask="000.000.000-00" class="form-control" type="text" name="cpfPassageiro" id="cpf"
                        placeholder="CPF"></div>
        ...
        <div class="col-6   d-flex mt-3 justify-content-center align-items-center ">
            <label class="col-4 ms-2" for="dataNasc">Data Nascimento:</label>
